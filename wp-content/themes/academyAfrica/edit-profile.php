...
if (is_user_logged_in()) {
    ...
    $page_title = get_theme_mod('page_title', 'Profile Settings');
    $avatar_label = get_theme_mod('avatar_label', 'Change your profile image');
    $upload_text = get_theme_mod('upload_text', 'upload');
    $view_my_courses = get_theme_mod('view_my_courses', 'View your courses');
    $form_description = get_theme_mod('form_description', 'Please enter your information and indicate whether you would like it to be visible to the public.');
    $first_name_label = get_theme_mod('first_name_label', 'First Name');
    $last_name_label = get_theme_mod('last_name_label', 'Last Name');
    $facebook_label = get_theme_mod('facebook_label', 'Facebook');
    $linked_in_label = get_theme_mod('linked_in_label', 'Linked In');
    $slack_label = get_theme_mod('slack_label', 'Slack');
    $city_label = get_theme_mod('city_label', 'City');
    $company_label = get_theme_mod('company_label', 'Company');
    $country_label = get_theme_mod('country_label', 'Country');
    $phone_label = get_theme_mod('phone_label', 'Phone');
    $email_label = get_theme_mod('email_label', 'Email');
    $twitter_label = get_theme_mod('twitter_label', 'Twitter');
    $position_label = get_theme_mod('position_label', 'Position');
    $bio_label = get_theme_mod('bio_label', 'Tell us a little about yourself');
    $mandatory_label = get_theme_mod('mandatory_label', 'Mandatory Fields');
    $receive_updates_label = get_theme_mod('receive_updates_label', 'Would you like to receive email updates about new content and events by academy.AFRICA?');
    $new_courses_label = get_theme_mod('new_courses_label', 'New Courses');
    $new_events_label = get_theme_mod('new_events_label', 'New Events');
    $save_changes_label = get_theme_mod('save_changes_label', 'Save Changes');
    $settings_title = get_theme_mod('settings_title', 'Network Settings');
    $settings_description = get_theme_mod('settings_description', 'Please indicate the networks you belong to or use the ‘Join’ button to join a network.');
    $membership_label = get_theme_mod('membership_label', 'I’m already a member');
