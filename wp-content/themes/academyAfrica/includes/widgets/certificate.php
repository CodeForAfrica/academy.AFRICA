...
?>
        <div class="certificate">
            <div class="certificate-header"> <?php echo $certificate_header; ?> </div>
            <div class="certificate-showcase">
                <div class="certificate">
                    ...
                    <div class="certificate-footer">
                        <img class="logo" alt="logo" src="<? echo $art_board ?>" />
                        <p class="company-name">
                            <? echo $company_name ?>
                        </p>
                        <img class="artwork" alt="artwork" src="<? echo $company_image ?>" />
                        <div class="signature">
                ...
                <div class="certificate-showcase-content">
                    ...
                    <a class="buton primary large all-courses" href="<?php echo $courses_link['url']; ?>">
