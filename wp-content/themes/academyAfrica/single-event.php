                ...
                <div class="share">
                    <div style="margin-bottom: 20px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <rect x="0.05" y="0.05" width="23.9" height="23.9" stroke="black" stroke-opacity="0.1" stroke-width="0.1" />
                            ...
                            <path d="M8.58984 13.5117L15.4198 17.4917" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.4098 6.51172L8.58984 10.4917" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <?
                    if ($is_past_event) {
