...
<div style="display: flex;" class="share-menu">
    ...
    <div class="share-icons">
        <!-- LinkedIn -->
        <a style="color: #000; margin-right: 8px;" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $url_to_share; ?>&summary=<?php echo urlencode($share_message); ?>" target="_blank">
        ...
        <!-- Twitter -->
        <a style="color: #000; margin-right: 8px;" href="https://twitter.com/intent/tweet?url=<?php echo $url_to_share; ?>&text=<?php echo urlencode($share_message); ?>" target="_blank">
        ...
        <!-- Facebook -->
        <a style="color: #000; margin-right: 8px;" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url_to_share; ?>&quote=<?php echo urlencode($share_message); ?>" target="_blank">
