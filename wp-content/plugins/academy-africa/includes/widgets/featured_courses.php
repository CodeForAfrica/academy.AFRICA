                ...
                <div class="content">
                    ...
                    if (!empty($courses)) {
                        foreach ($courses as $course) {
                            ...
                            ?>
                            <div class="card">
                                <img alt="course-logo" class="logo"
                                    src="/wp-content/plugins/academy-africa/includes/assets/images/course-image.png" />
